...
Also incorporates improvements from HF math_verify, verl, open reasoner zero, etc.
"""
...
https://github.com/NiklasFreymuth/troll/blob/main/verl/recipe/entropy/reward_score/entropy_math/__init__.py
"""
